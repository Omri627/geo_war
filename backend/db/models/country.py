...
class Country():
    ...
    def __init__(self, record: tuple):
        ...
        self._0_14_years = record[9]
        self._15_24_years = record[10]
        self._25_54_years = record[11]
        self._55_64_years = record[12]
        self._65_over = record[13]
        self.total_median_age = record[14]
        self.female_median_age = record[15]
        self.male_median_age = record[16]
        self.male_expectancy = record[17]
        self.female_expectancy = float(record[18])
        self.total_expectancy = float(record[19])
        self.unemployment_rate = float(record[20])
        self.revenues = record[21]
        self.expenditures = record[22]
        self.imports = record[23]
        self.exports = record[24]
